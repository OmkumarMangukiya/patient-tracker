...
function AddPatient({ formInputs = null, onInputChange = null }) {
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-surface-lowest rounded-lg shadow">
      ...
      <button
        ...
        disabled={loading}
        className={`w-full py-2 px-4 rounded font-medium text-black ${loading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'
          }`}
      >
