...
function SetPassword() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-surface p-4 sm:p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700 relative overflow-hidden">
      ...
      <div className="fixed top-[-20%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-primary/5 blur-3xl opacity-50 pointer-events-none"></div>
      <div className="fixed bottom-[-20%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-primary-container/5 blur-3xl opacity-50 pointer-events-none"></div>
      ...
      <div className="w-full max-w-md bg-surface-lowest rounded-3xl p-8 sm:p-10 shadow-[0_20px_60px_rgba(12,30,38,0.05)] ring-1 ring-outline-variant/20 relative z-10">
        <div className="text-left mb-8">
          <h1 className="text-3xl font-bold text-primary-container tracking-tight mb-2">Set Password</h1>
          <p className="text-on-surface-variant font-medium text-sm">
            Please create a secure password to finalize your account setup.
          </p>
        </div>
